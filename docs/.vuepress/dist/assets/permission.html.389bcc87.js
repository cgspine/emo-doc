import{_ as e,r as t,o as i,c as o,b as n,d as s,e as p,a as l}from"./app.a708b556.js";const c="/images/permission.jpg",u={},r=l('<h1 id="权限" tabindex="-1"><a class="header-anchor" href="#权限" aria-hidden="true">#</a> 权限</h1><p>国内现在的审核机制，基本上都需要在申请权限时要出一个申请权限的理由，目前的交互设计都趋于归一化（如下图），因为 <code>emo</code> 做了统一的封装。</p><img width="280" alt="权限申请示例" src="'+c+`"><blockquote><p>注：此库不包含对特定权限的兼容性处理</p></blockquote><h2 id="依赖引入" tabindex="-1"><a class="header-anchor" href="#依赖引入" aria-hidden="true">#</a> 依赖引入</h2><div class="language-kts line-numbers-mode" data-ext="kts"><pre class="language-kts"><code><span class="token comment">// 此组件依赖了 modal 组件</span>
<span class="token function">implementation</span><span class="token punctuation">(</span><span class="token string-literal singleline"><span class="token string">&quot;cn.qhplus.emo:permission:0.7.0&quot;</span></span><span class="token punctuation">)</span>
